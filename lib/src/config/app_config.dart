      ...
      InterceptorsWrapper(
        ...
        onError: (DioException e, handler) async {
          if (e.response?.statusCode == 401) {
            ...
            final refreshResult = await SecureStorageService.instance.read('refresh_token');
            String? refreshToken;
            ...
            if (refreshToken != null && refreshToken!.trim().isNotEmpty) {
              try {
                ...
                if (response.statusCode == 200 || response.statusCode == 201) {
                  ...
                  await SecureStorageService.instance.write('access_token', newAccessToken);
                  await SecureStorageService.instance.write('refresh_token', newRefreshToken);
