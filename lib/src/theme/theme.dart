  ...
  return ThemeData(
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        side: BorderSide(color: customColors.border, width: 1.5),
      ),
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: BorderSide(color: customColors.ring, width: 2),
      ),
...
ThemeData buildLightTheme({required String primaryColorHex}) {
  final seed = primaryColorHex.isNotEmpty && primaryColorHex != '#6750A4'
      ? _colorFromHex(primaryColorHex)
  ...
  final colorScheme = baseScheme.copyWith(
    primary: AppPalettes.primaryLight,
    onPrimary: Colors.white,
    secondary: AppPalettes.primary2Light,
    onSecondary: Colors.white,
    tertiary: AppPalettes.accentLight,
    onTertiary: Colors.white,
    surface: AppPalettes.backgroundLight,
    onSurface: AppPalettes.foregroundLight,
    surfaceContainerLow: AppPalettes.cardLight,
    outline: AppPalettes.borderLight,
    outlineVariant: AppPalettes.borderLight.withValues(alpha: 0.5),
  );
...
ThemeData buildDarkTheme({required String primaryColorHex}) {
  ...
  final colorScheme = baseScheme.copyWith(
    ...
    onPrimary: AppPalettes.backgroundDark,
    secondary: AppPalettes.primary2Dark,
    onSecondary: AppPalettes.backgroundDark,
    tertiary: AppPalettes.accentDark,
    onTertiary: AppPalettes.backgroundDark,
    surface: AppPalettes.backgroundDark,
    onSurface: AppPalettes.foregroundDark,
    surfaceContainerLow: AppPalettes.cardDark,
    outline: AppPalettes.borderDark,
    outlineVariant: AppPalettes.borderDark.withValues(alpha: 0.5),
  );
